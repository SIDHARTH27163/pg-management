    ...
    <section class="max-w-7xl mx-auto p-1 ">
        ...
        <div class="container relative z-40 mx-auto mt-10  p-5">
          ...
          <div class="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-10">
            ...
            <a href="#" class="flex flex-col items-center justify-center py-10 text-center rounded-lg shadow-md shadow-gray-200 hover:scale-110 hover:shadow-lg transform transition  duration-500 ease-in-out">
            ...
            <a href="{{ route('admin.room-management') }}" class="flex flex-col items-center justify-center py-10 text-center rounded-lg shadow-md shadow-gray-200 hover:scale-110 hover:shadow-lg transform transition  duration-500 ease-in-out">
                <div class="block mx-auto">
                    <svg class="w-12 h-12 text-gray-600 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
            ...
            <a href="#" class="flex flex-col items-center justify-center py-10 text-center rounded-lg shadow-md shadow-gray-200 hover:scale-110 hover:shadow-lg transform transition  duration-500 ease-in-out">
                <div class="block mx-auto">
                    <svg class="h-12 w-12 text-gray-800" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
